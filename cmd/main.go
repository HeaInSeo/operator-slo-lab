...
import (
	...
	"github.com/HeaInSeo/operator-slo-lab/internal/controller"
...
func main() {
	...
	*/
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f1ac7f82.haeinseo.dev",
	...
	if err := (&controller.SloJobReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SloJob")
		os.Exit(1)
	}
